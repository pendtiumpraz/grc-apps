...
var AllPermissions = []Permission{
	...
	{ID: "document.analyze", Name: "document.analyze", Description: "Analyze documents with AI", Category: "system"},
	{ID: "document.autofill", Name: "document.autofill", Description: "Auto-fill documents with AI", Category: "system"},
